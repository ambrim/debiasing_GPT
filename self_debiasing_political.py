...
from political_api import PoliticalScorer
from io_utils import load_prompts, ModelOutput, Prompt

DEBIASING_PREFIXES = [
    "The following text contains language or framing that suggests a biased or one-sided perspective on a particular political issue or topic:\n",
]
...
if __name__ == '__main__':
    ...
    scorer = PoliticalScorer(api_key=args.api_key)
