...
from perspective_api_insult import PerspectiveApiInsultScorer
from io_utils import load_prompts, ModelOutput, Prompt

DEBIASING_PREFIXES = [
    "The following text contains insulting, inflammatory, or negative comment towards a person or a group of people:\n",
]
...
if __name__ == '__main__':
    ...
    scorer = PerspectiveApiInsultScorer(api_key=args.api_key)
